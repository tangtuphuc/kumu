                ...
                <div class="setting-source">
                    ...
                    <div class="setting-source-info">
                        ...
                        <div v-else-if="settingSource.type === 'file'">
                            <file-input fileId="settingSourceFile" @fileSelected="updateSettingSourceFile"></file-input>
                        </div>
                    </div>
                    ...
                    <div class="destination-info input-group">
                        ...
                        <input class="form-control" type="disabled" :value="destinationHotel.name" />
                    </div>
                    ...
                    <div class="button-group">
                        <color-button type="button" class="btn btn-outline-secondary" @click="backPreviousPage">
                            {{ 'Cancel' }}
                        </color-button>
                        <color-button type="button" class="btn btn-outline-primary" @click="onApplyClicked">
                            {{ 'Apply' }}
                        </color-button>
                    </div>
                </div>
