            ...
            <div class="list-item">
                ...
                <div class="list-box">
                    ...
                    >
                        ...
                        <div v-if="showDeleteButton && item[textShowField]" class="right-row" @click="itemDelete(item)">
                            X
                        </div>
                    </div>
                </div>
    ...
    props: {
        ...
        list: {
            ...
            default() {
                ...
                console.warn('SentenceList: Set `showFilterBar`, `showDeleteButton`, `showId` if neccessary');
                return [
                    {
                        id: 1,
